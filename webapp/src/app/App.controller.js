	...
	return BaseController.extend("AgendaInvent.src.app.App", {
		...
		loggedPopOver : function(oEvent){
			...
			if (!this._oPopoverLogged) {
			    this._oPopoverLogged = sap.ui.xmlfragment("AgendaInvent.src.pages.security.Logged", this);
		...
		createNavigation(){
			...
			const sideMenu = sap.ui.xmlfragment("AgendaInvent.src.app.SideMenu", this);
